...
const doClassify = async (e, results) => {
    e.preventDefault();
    ...
    const resp = await fetch(`${API_ADDR}/classify`, {
        method: 'post',
...
export function doForm() {
    ...
    document.querySelector('#form').addEventListener('submit', (event) => doClassify(event, results));
}
